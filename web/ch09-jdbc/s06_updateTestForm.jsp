...
<div class="page-main">
  ...
  <%
    ...
    try{
      ...
      //JDBC수행 4단계 : SQL문을 테이블에 반영하고 ResultSet에 담음
        ...
        <form id="myForm" action="s07_updateTest.jsp" method="post">
          ...
          <ul>
            ...
            <li>
              ...
              <input type="text" name="passwd" id="passwd" value="<%=title%>" size="20" maxlength="10">
            </li>
            <li>
  ...
  <div class="result-display">
    <div class="align-center">
      ...
      <input type="button" value="목록"  onclick="location.herf='s04_selectTest.jsp'">
    </div>
  </div>
  <%
      }
